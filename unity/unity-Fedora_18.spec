...
BuildRequires:	compiz-ABI = 20121210
Requires:	compiz-ABI = 20121210
...
%changelog
* Fri Feb 01 2013 Xiao-Long Chen <chenxiaolong@cxl.epac.to> - 6.12.0daily13.01.25.1-1.0ubuntu1
- Version 6.12.0daily13.01.25.1
- Ubuntu release 0ubuntu1
- Drop 0001_fix_gtest_directory.patch
  + Replaced with 0001_Remove_gtest.patch
  + Unity's CMakeLists.txt is designed for Ubuntu's packaging of gtest
- Drop 0003_Ignore_deprecated_schema_path.patch
  + Fixed upstream
- Drop 0004_CMake_workaround.patch
  + Fixed upstream
- Drop 0005_link_dbus-glib.patch
  + Fixed upstream
- Drop 0007_link_gmodule.patch
  + Fixed upstream
- Drop 0009_Include_iostream.patch
  + Fixed upstream
- Bump compiz-ABI requirement to 20121210
- Bump nux requirement to 4.0
