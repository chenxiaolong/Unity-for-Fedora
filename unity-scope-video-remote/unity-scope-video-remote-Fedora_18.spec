...
%files
%doc COPYING
%{python_sitelib}/unity_scope_video_remote-*-py*.egg-info
...
%changelog
* Fri Feb 01 2013 Xiao-Long Chen <chenxiaolong@cxl.epac.to> - 0.3.10daily12.12.05-1
- Version 0.3.10daily12.12.05
